export const menuItems = [
    ...
    },
    {
        ...
        icon: 'fas fa-coins',
        dropdown: [
            { id: 2, text: 'CQ9 Trực tuyến', icon: 'https://qk3x72.katawee.net/system-requirement/Web.Portal/_Common/Supplier/30x30/cq9.png', type: "image" },
            { id: 3, text: 'PP Trực tuyến', icon: 'https://qk3x72.katawee.net/system-requirement/Web.Portal/_Common/Supplier/30x30/pp.png', type: "image" },
            { id: 13, text: 'WM Trực tuyến', icon: 'https://qk3x72.katawee.net/system-requirement/Web.Portal/_Common/Supplier/30x30/wm.png', type: "image" },
            { id: 14, text: 'SBO Trực tuyến', icon: 'https://qk3x72.katawee.net/system-requirement/Web.Portal/_Common/Supplier/30x30/sbo.png', type: "image" },
            { id: 16, text: 'FK Trực tuyến', icon: 'https://qk3x72.katawee.net/system-requirement/Web.Portal/_Common/Supplier/30x30/fg.png', type: "image" },
            { id: 22, text: 'YG Trực tuyến', icon: 'https://qk3x72.katawee.net/system-requirement/Web.Portal/_Common/Supplier/30x30/yg.png', type: "image" },
            { id: 29, text: 'MG Trực tuyến', icon: 'https://qk3x72.katawee.net/system-requirement/Web.Portal/_Common/Supplier/30x30/mg.png', type: "image" },
            { id: 35, text: 'PG Trực tuyến', icon: 'https://qk3x72.katawee.net/system-requirement/Web.Portal/_Common/Supplier/30x30/pg.png', type: "image" },
            // { id: 1009, text: 'MP Trực tuyến', icon: 'https://qk3x72.katawee.net/system-requirement/Web.Portal/_Common/Supplier/30x30/mg.png', type: "image" },
            { id: 1010, text: 'YGR Trực tuyến', icon: 'https://qk3x72.katawee.net/system-requirement/Web.Portal/_Common/Supplier/30x30/ygr.png', type: "image" },
            { id: 1018, text: 'PT Trực tuyến', icon: 'https://qk3x72.katawee.net/system-requirement/Web.Portal/_Common/Supplier/30x30/pt.png', type: "image" },
...

    {
        ...
        icon: 'fas fa-crown',
        dropdown: [
            { id: 'vipclub-bronze', text: 'VIP Đồng', icon: 'fas fa-medal' },
            { id: 'vipclub-silver', text: 'VIP Bạc', icon: 'fas fa-medal' },
            { id: 'vipclub-gold', text: 'VIP Vàng', icon: 'fas fa-medal' },
            { id: 'vipclub-platinum', text: 'VIP Bạch kim', icon: 'fas fa-medal' },
            { id: 'vipclub-diamond', text: 'VIP Kim cương', icon: 'fas fa-gem' }
        ]
    },
    {
        id: 'daily',
        ...
        dropdown: [
            { id: 'daily-register', text: 'Đăng ký đại lý', icon: 'fas fa-user-plus' },
            { id: 'daily-login', text: 'Đăng nhập đại lý', icon: 'fas fa-sign-in-alt' },
            { id: 'daily-commission', text: 'Hoa hồng', icon: 'fas fa-percentage' },
            { id: 'daily-report', text: 'Báo cáo', icon: 'fas fa-chart-bar' },
            { id: 'daily-support', text: 'Hỗ trợ đại lý', icon: 'fas fa-headset' }
        ]
    },
    {
        id: 'thuonghieu',
        ...
        icon: 'fas fa-star',
        dropdown: [
            { id: 'thuonghieu-evolution', text: 'Evolution Gaming', icon: 'fas fa-gamepad' },
            { id: 'thuonghieu-pragmatic', text: 'Pragmatic Play', icon: 'fas fa-play' },
